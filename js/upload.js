...
function getFileSharingPermission(fid){
...
//using getFileSharingPermission() function which just move it to public folder
       ...
       const html=  `
        ...
        ru.Do(resource, function(res, err) {
          ...
          try{
              ...
              getFileSharingPermission(res.result.id)
